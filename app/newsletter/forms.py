...
class NewsletterTemplateForm(FlaskForm):
    ...
    sponsy_top_placement_id = SelectField('Sponsy Top Ad Placement ID', choices=[], validators=[Optional()])
    sponsy_mid_placement_id = SelectField('Sponsy Mid-Content Ad Placement ID', choices=[], validators=[Optional()])
