...
class NewsletterTemplateForm(FlaskForm):
    ...
    sponsy_top_placement_id = StringField('Sponsy Top Ad Placement ID', validators=[Optional()])
    sponsy_mid_placement_id = StringField('Sponsy Mid-Content Ad Placement ID', validators=[Optional()])
